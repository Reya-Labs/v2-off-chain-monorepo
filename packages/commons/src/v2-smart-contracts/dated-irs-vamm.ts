...
export const getDatedIrsVammContract = (
  ...
  const abi = [
    ...
    `event Swap(uint128 marketId, uint32 maturityTimestamp, address sender, int256 desiredBaseAmount, uint160 sqrtPriceLimitX96, int256 quoteTokenDelta, int256 baseTokenDelta, uint256 blockTimestamp)`,
  ];
