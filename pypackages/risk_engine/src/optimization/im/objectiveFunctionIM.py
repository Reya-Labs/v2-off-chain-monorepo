...
def objective_function_im(lp_liquidation_threshold: Series, trader_liquidation_threshold: Series,
    ...
    lvar_reg = MAX_OBJECTIVE_PENALTY if average_liquidations_var < ACCEPTABLE_IVAR_THRESHOLD else 0

    objective = average_leverage - average_risk - regularisation - lvar_reg
